/**
 * PEG.js v0.11.0, 4ef61cd8282d36a4cf13
 * https://pegjs.org/
 *
...
var objects = __webpack_require__(11);

var vm = __webpack_require__(4);

var convertPasses = function () {
...
exports.visitor = __webpack_require__(3);
exports.Node = __webpack_require__(5);
exports.Grammar = __webpack_require__(12);
...
function peg$parse(input, options) {
  ...
  var peg$f40 = function peg$f40(code) {
...
var GrammarError = __webpack_require__(2);
...
var peg = {
  ...
  compiler: compiler,
  util: util,
  generate: function generate(grammar) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var session = new compiler.Session({
...
var calcReportFailures = __webpack_require__(14);

var generateBytecode = __webpack_require__(15);

var generateJS = __webpack_require__(16);

var removeProxyRules = __webpack_require__(17);

var reportDuplicateLabels = __webpack_require__(18);

var reportDuplicateRules = __webpack_require__(19);

var reportUnusedRules = __webpack_require__(20);

var reportInfiniteRecursion = __webpack_require__(21);

var reportInfiniteRepetition = __webpack_require__(22);

var reportUndefinedRules = __webpack_require__(23);

var inferenceMatchResult = __webpack_require__(24);

var reportIncorrectPlucking = __webpack_require__(25);
...
var compiler = {
  ...
  compile: function compile(ast, session) {
    ...
    util.each(session.passes, function (stage) {
    ...
    switch (options.output) {
      ...
      default:
        session.error("Invalid output format: ".concat(options.output, "."));
    }
  }
};
...
var opcodes = __webpack_require__(27);
